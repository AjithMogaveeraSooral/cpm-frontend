  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-12">
      <div className="mb-8">
        ...
        <p className="mt-2 text-slate-600">Browse homes listed on Cypress. Sign in to enquire or apply.</p>
      </div>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {items.map((p) => (
          <div key={p.upid} className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="p-5">
              ...
              {p.deposit > 0 && (
                <p className="mt-1 text-xs text-slate-500">Deposit {formatINR(p.deposit)}</p>
              )}
            </div>
          </div>
        ))}
